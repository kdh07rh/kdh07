...
@WebServlet("/thread-occupier-1")
public class ThreadOccupier1Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<h2>🔒 Thread Occupier 1</h2>");
        ...
        System.out.println(String.format(
            "[%s] 🟡 Thread-Occupier-1 START - Thread: %s", 
        ...
        System.out.println(String.format(
            "[%s] ✅ Thread-Occupier-1 END - Thread: %s", 
            endTime, threadName
        ));
    }
}