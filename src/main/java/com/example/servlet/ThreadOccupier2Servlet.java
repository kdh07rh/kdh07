...
@WebServlet("/thread-occupier-2")
public class ThreadOccupier2Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<h2>🔒 Thread Occupier 2</h2>");
        ...
        System.out.println(String.format(
            "[%s] 🟡 Thread-Occupier-2 START - Thread: %s", 
        ...
        System.out.println(String.format(
            "[%s] ✅ Thread-Occupier-2 END - Thread: %s", 
            endTime, threadName
        ));
    }
}