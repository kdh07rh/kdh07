...
@WebServlet("/thread-occupier-3")
public class ThreadOccupier3Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<h2>🔒 Thread Occupier 3</h2>");
        ...
        System.out.println(String.format(
            "[%s] 🟡 Thread-Occupier-3 START - Thread: %s", 
        ...
        System.out.println(String.format(
            "[%s] ✅ Thread-Occupier-3 END - Thread: %s", 
            endTime, threadName
        ));
    }
}