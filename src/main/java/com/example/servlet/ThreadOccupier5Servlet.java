...
@WebServlet("/thread-occupier-5")
public class ThreadOccupier5Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<h2>🔒 Thread Occupier 5</h2>");
        ...
        System.out.println(String.format(
            "[%s] 🟡 Thread-Occupier-5 START - Thread: %s", 
        ...
        System.out.println(String.format(
            "[%s] ✅ Thread-Occupier-5 END - Thread: %s", 
            endTime, threadName
        ));
    }
}