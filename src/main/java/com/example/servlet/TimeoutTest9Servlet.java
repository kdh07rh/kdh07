...
@WebServlet("/timeout-test-9")
public class TimeoutTest9Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<h2>⏱️ Timeout Test Page 9</h2>");
        out.println("<p><strong>시작 시간:</strong> " + startTime + "</p>");
        out.println("<p><strong>스레드:</strong> " + threadName + "</p>");
        out.println("<p style='color: orange; font-size: 16px;'><b>5초 딜레이 처리 중... (9/10)</b></p>");
        out.flush();
        
        System.out.println(String.format(
            "[%s] ⏱️ Timeout-Test-9 START - Thread: %s", 
        ...
        out.println("<p style='color: green; font-size: 16px;'><b>Timeout Test 9 완료!</b></p>");
        out.println("</body></html>");
        
        System.out.println(String.format(
            "[%s] ✅ Timeout-Test-9 END - Thread: %s", 
            endTime, threadName
        ));
    }
