...
<html>
<head>
    <title>Thread Block 5</title>
    <meta charset="UTF-8">
</head>
<body>
    <h2>🔒 Thread Block 5 - 5분 대기</h2>
    ...
    <%
        ...
        System.out.println(String.format(
            "[%s] 🔵 Thread-Block-5 START - Thread: %s", 
        ...
        try {
            ...
            System.out.println("Thread-Block-5 interrupted: " + e.getMessage());
        }
