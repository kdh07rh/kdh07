...
<html>
<head>
    <title>Thread Block 1</title>
    <meta charset="UTF-8">
</head>
<body>
    <h2>🔒 Thread Block 1 - 5분 대기</h2>
    ...
    <%
        ...
        System.out.println(String.format(
            "[%s] 🔴 Thread-Block-1 START - Thread: %s", 
        ...
        try {
            ...
            System.out.println("Thread-Block-1 interrupted: " + e.getMessage());
        }
