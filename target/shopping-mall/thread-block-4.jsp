...
<html>
<head>
    <title>Thread Block 4</title>
    <meta charset="UTF-8">
</head>
<body>
    <h2>🔒 Thread Block 4 - 5분 대기</h2>
    ...
    <%
        ...
        System.out.println(String.format(
            "[%s] 🟢 Thread-Block-4 START - Thread: %s", 
        ...
        try {
            ...
            System.out.println("Thread-Block-4 interrupted: " + e.getMessage());
        }
